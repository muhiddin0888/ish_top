...
class _AddAnnouncementPageState extends State<AddAnnouncementPage> {
                ...
                builder: (context, state) {
                  return ActiveButton(
                      ...
                      onPressed: () {
                        ...
                        if (currentPage == 3) {
                          if (isPageFourValidated(fields: t.state.fields, cvUrl: state.cvUrl.downloadUrl)) {
                            BlocProvider.of<AnnouncementCubit>(context)
                                .updateCurrentItem(
                              fieldValue: BlocProvider.of<AppBloc>(context)
                                  .state
  ...
  bool isPageFourValidated({required Map<String, dynamic> fields, required String cvUrl}) {
    bool isValid = false;
